...
//faq DOM manip. for answers
  ...
  $("#faqQ3").click(function(){
    $("#faqAnswer").empty();
    $("<h6>As a physical therapist, I am an expert of diagnosis and treatment of musculoskeletal conditions, most of which impair your ability to move and function in your day to day life without limitations or discomfort. Our professional governing body, the <a href='https://www.moveforwardpt.com/Default.aspx' target='_blank'>American Physical Therapy Association (APTA)</a> has a wonderful resource page which provides good background information on common conditions any physical therapist can treat successfully. I have a specific interest in all aspects of Temporomandibular Disorders (TMD, previously known as TMJ), chronic headache conditions, whiplash, and concussion injuries. I specialize in conditions of the jaw, head, and neck. I personally excel at treating persistent pain and conditions that have been non-responsive to other conservative treatment approaches. As a highly trained manual therapist, my advanced clinical reasoning and handling skills make successfully treating these complex conditions interesting and extremely rewarding.</h6>").hide().appendTo("#faqAnswer").fadeIn(800);
  });
